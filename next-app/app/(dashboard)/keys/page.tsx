...
export default function KeysPage() {
  ...
  return (
    <div style={{ padding: '40px 48px', maxWidth: 880 }}>
        ...
        <div className="modal-overlay" onClick={e => e.target === e.currentTarget && setShowCreate(false)}>
          <div className="modal-box fade-in">
            ...
            <p style={{ ...mono, fontSize: 12, color: 'var(--text-muted)', marginBottom: 24 }}>
              Issue a key for one of your AI agents.
            </p>
            ...
            <form onSubmit={handleCreate}>
              <div className="field">
                ...
                <input
                  ...
                  placeholder="e.g. Sales Bot, WhatsApp Agent"
                  required
                  autoFocus
                />
              </div>
      ...
      {/* Keys list */}
      {loading ? (
        <p style={{ ...mono, fontSize: 12, color: 'var(--text-faint)', textAlign: 'center', paddingTop: 60 }}>
          loading keys…
        </p>
      ) : keys.length === 0 ? (
        <div style={{ textAlign: 'center', paddingTop: 80 }}>
          ...
          <p style={{ ...mono, fontSize: 12, color: 'var(--text-muted)' }}>Create your first API key to get started</p>
        </div>
      ) : (
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                  {key.status === 'ACTIVE' && (
                    <button
                      ...
                      style={{ ...mono, fontSize: 10, padding: '4px 10px' }}
                    >
                      Revoke
                    </button>
                  )}
